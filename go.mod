module github.com/fanfury-sports/core/v2
...
replace (
	...
	github.com/cosmos/cosmos-sdk => github.com/fanfury-sports/cosmos-sdk v0.47.5-furya.2
	github.com/cosmos/ledger-cosmos-go => github.com/fanfury-sports/ledger-furya-go v0.11.2
