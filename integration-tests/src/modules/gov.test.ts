...
import { Coins, MsgVote, Fee, MsgSubmitProposal, Proposal, Int } from "@fanfury-sports/feather.js";
import { blockInclusion, votingPeriod } from "../helpers/const";
import { ProposalStatus, VoteOption } from "@fanfury-sports/furya.proto/cosmos/gov/v1beta1/gov";

describe("Governance Module (https://github.com/fanfury-sports/cosmos-sdk/tree/release/v0.47.x/x/gov) ", () => {
