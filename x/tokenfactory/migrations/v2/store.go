...
import (
	...
	"github.com/fanfury-sports/core/v2/x/tokenfactory/exported"
	"github.com/fanfury-sports/core/v2/x/tokenfactory/types"
)
...
func MigrateStore(ctx sdk.Context, legacySubspace exported.Subspace, cdc codec.BinaryCodec) error {
	...
	// https://github.com/fanfury-sports/core/blob/a03a0657c7430d32e6329d86de78bb4aab9a9aa7/app/app.go#L1053
